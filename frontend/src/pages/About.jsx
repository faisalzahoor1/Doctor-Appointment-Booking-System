...
export const About = () => {
  return (
    <div>
        <div className='text-center text-2xl pt-10 text-gray-500'>ABOUT <span className='text-gray-700 font-medium'>US</span></div>
        <div className='my-10 flex flex-col md:flex-row gap-12'>
          {
            <img className='w-full md:max-w-[360px] ml-8' src={assets.about_image} alt="" />
          }
          <div className='flex flex-col justify-center gap-6 mr-8 font-xs md:w-2/4 text-sm '>
        ...
        <div className='text-xl my-4'>
          <p className='text-2xl ml-8'>WHY <span className='text-gray-700 font-semibold'>CHOOSE US</span></p>
        </div>

        <div className='flex flex-row ml-8 mr-8 md:flex-row mb-20'>
